...
public class JwtTokenUserInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            String standard_token = stringRedisTemplate.opsForValue().get(KEY_PREFIX + id);
            ...
            stringRedisTemplate.expire(KEY_PREFIX + id, jwtProperties.getUserTtl(), TimeUnit.SECONDS);
